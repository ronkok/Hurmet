...
//    ["sin(degAngle) = @@", "¿degAngle sin", "0.5"],
    ...
    ["vector[1..] = @", `¿vector ®1/1 "∞" .. [] 1`, "[2.1; -15.3; 11]"],
    ...
    [`wideFlanges[["W10X49"; "W8X31"]]["area", "d"] = @`, `¿wideFlanges "W10X49" "W8X31" matrix 2 1 [] 1 "area" "d" [] 2`, ""],
    ['"ab" & "cd" = @', `"ab" "cd" &`, 'abcd'],
    ...
    [`vector &_ vector = @`, `¿vector ¿vector &_`, "[2.1; -15.3; 11; 2.1; -15.3; 11]"],
    [`vector^T & vector^T = @`, `¿vector ¿T ^ ¿vector ¿T ^ &`, "[2.1, -15.3, 11, 2.1, -15.3, 11]"],
    [`vector^T &_ vector^T = @`, `¿vector ¿T ^ ¿vector ¿T ^ &_`, "(2.1, -15.3, 11; 2.1, -15.3, 11)"],
    [`matrix & vector[1..2] = @`, `¿matrix ¿vector ®1/1 ®2/1 .. [] 1 &`, "(2.1, 7.5, 2.1; -15.3, 33, -15.3)"],
    [`matrix &_ vector[1..2]^T = @`, `¿matrix ¿vector ®1/1 ®2/1 .. [] 1 ¿T ^ &_`, "(2.1, 7.5; -15.3, 33; 2.1, -15.3)"],
